...
const asplund_2020_solar_abundances = [
        12.00, 10.914, 0.96,  1.38,  2.70, 8.46,  7.83,  8.69,  4.40,
        ...
        2.32,  2.83,   2.21,  2.59,  1.47, 1.88, -5.00,  1.75,  0.78, 
        1.57,  0.96,   1.71,  0.80,  2.02, 1.01,  2.18,  1.55,  2.22, 
        1.08,  2.27,   1.11,  1.58,  0.75, 1.42,  0.95,  0.52,  1.08, 
        0.31,  1.10,   0.48,  0.93,  0.11, 0.85,  0.10,  0.85, -0.15, 
        0.79,  0.26,   1.35,  1.32,  1.61, 0.91,  1.17,  0.92,  1.95, 
        0.65,  0.03,   1.75, -0.54,  0.78, 1.57,  0.96,  1.71,  0.80, 
        2.02,  1.01,   2.18,  1.55,  2.22, 1.08,  2.27,  1.11,  1.58, 
        0.75,  1.42,   0.95,  0.52,  1.08, 0.31,  1.10,  0.48,  0.93, 
        0.11,  0.85,   0.10,  0.85, -0.15, 0.79,  0.26,  1.35,  1.32, 
        1.61,  0.91,   1.17,  0.92,  1.95, 0.65,  0.03, -0.54]

#uncertainties associated with solar/meteoritic abundances per Asplund et al. A&A 653, A141 (2021).
const asplund_2020_solar_abundance_uncertainties = [
        0.00,  0.013,  0.06,  0.09,  0.20, 0.04,  0.07,  0.04,  0.25,
        0.05,  0.03,   0.03,  0.03,  0.03, 0.03,  0.03,  0.20,  0.10,
        0.03,  0.03,   0.04,  0.05,  0.08, 0.04,  0.06,  0.04,  0.05,
        0.04,  0.05,   0.05,  0.05,  0.10, 0.04,  0.03,  0.06,  0.10,
        0.08,  0.06,   0.05,  0.04,  0.06, 0.09,  NaN,   0.08,  0.11,
        0.10,  0.10,   0.03,  0.20,  0.10, 0.06,  0.03,  0.08,  0.05,
        0.03,  0.05,   0.04,  0.04,  0.05, 0.04,  0.04,  0.04,  0.04,
        0.10,  0.04,   0.11,  0.05,  0.04, 0.11,  0.09,  0.05,  0.04,
        0.11,  0.02,   0.12,  0.02,  0.02, 0.12,  0.18,  0.17,  0.08,
        0.04,  0.10,   0.08,  0.03,  0.11, 0.10,  0.10,  0.03,  0.20,
        0.10,  0.06,   0.03,  0.08,  0.05, 0.03,  0.05,  0.04,  0.04,
        0.05,  0.04,   0.04,  0.04,  0.04, 0.10,  0.04,  0.11,  0.05,
        0.04,  0.11,   0.09,  0.05,  0.04, 0.11,  0.02,  0.12,  0.02,
        0.02,  0.12,   0.18,  0.17,  0.08, 0.04,  0.10,  0.03]