@testset "synth" begin
    ...
    @testset "basic functionality" begin
        ...
        atm = interpolate_marcs(5000, 4.5, format_A_X())
    ...
    @testset "resolution" begin
        ...
        @assert wls == wls_raw
        flux_manual_lsf = apply_LSF(flux_raw, wls_raw, 50_000)
    ...
    @testset "rotation" begin
        ...
        @assert wls == wls_raw
        flux_manual_rot = apply_rotation(flux_raw, wls_raw, 10)
    ...
    @testset "microturbulence" begin
        ...
        sol = synthesize(atm, default_linelist, format_A_X(), 5000, 5001; vmic=2.0)
        @test flux ≈ sol.flux ./ sol.cntm
    end
    ...
    @testset "linelist" begin
        ...
        sol = synthesize(atm, linelist, format_A_X(), 5000, 5001)
        @test flux ≈ sol.flux ./ sol.cntm
    end
